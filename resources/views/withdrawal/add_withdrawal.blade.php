      ...
      <div class="x_content">
        ...
        <form id="frm_agent_salary" action ="{{url('/salary/createSalary')}}" method="POST"  data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="agent_salary_paid_date"  value="" type="text" required="required" name="agent_salary_paid_date"  class="form-control col-md-7 col-xs-12 date_class" onkeydown="return false">
              </div>
          </div>
          <div class="form-group">
