  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        @endif
        <br />
        <form action ="{{url('/agent/updateAgent')}}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
          {{ csrf_field() }}
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input value="{{ $agent->agent_first_name }}" type="text" id="first_name" name="first_name" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input value="{{ $agent->agent_last_name }}" type="text" id="last_name" name="last_name" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="agent_joining_date"  value="{{ dmy($agent->agent_joining_date)}}" type="text" required="required" name="agent_joining_date"  class="form-control col-md-7 col-xs-12 date_class" onkeydown="return false">
              </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input maxlength="8" data-parsley-type="number" value="{{ $agent->agent_fixed_salary }}" type="text" id="agent_fixed_salary" name="agent_fixed_salary" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <textarea name="agent_address" id="agent_address" class="form-control"  data-parsley-trigger="keyup"  data-parsley-maxlength="300" >{{ $agent->agent_address }}</textarea>
              </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input data-parsley-minlength="4" value="{{ $agent->username }}" type="text" id="username" name="username" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input data-parsley-minlength="4" value="" data-parsley-equalto="#password" data-parsley-minlength="4" type="text" id="confirmPassword" name="confirmPassword" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
