              ...
              <tbody>
                @foreach ($customers_list as $customer)
                  <tr>
                    ...
                    <td><a class="btn btn-primary" href="{{url('/loan_requirement/customerRequirement/'.$customer->customer_id)}}">{{isLoanTaken($customer->customer_loan_taken)}}</a></td>
                    @else
                    <td><a class="btn btn-primary">{{isLoanTaken($customer->customer_loan_taken)}}</a></td>
                    @endif
