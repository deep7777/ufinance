      ...
      <div class="x_content">
        ...
        <form id="frm_agent_salary" action ="{{url('/salary/updateSalary')}}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input value="3" type="text" id="agent_comission" name="agent_comission" required="required" class="form-control col-md-7 col-xs-12 cal_comission agent_salary" style="background:yellow" >
            </div>
          </div>
          <div class="form-group">
