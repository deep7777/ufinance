...
<div class="x_title">
  <div class="pull-left red">Daily Loan Collection Amount - {{ getMYName($selected_month_year) }}</div>
  <div class="clearfix"></div>
</div>
...
<br>
<div class="x_title">
  <div class="pull-left red">Modify Daily Loan Collection Amount - {{ getMYName($selected_month_year) }}</div>
  <div class="clearfix"></div>
</div>
<table style="width:910px;color:black;" border="1" bordercolor="grey">
  <tr style="background: skyblue;">
