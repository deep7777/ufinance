...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
        <form id="frm_loan" action ="{{url('/loan/addCustomerLoan')}}" method="POST"  data-parsley-validate class="form-horizontal form-label-left">
          {{ csrf_field() }}
          <input id="url" type="hidden" value="{{url("/")}}">
          <div class="row">
            <div class="form-group col-md-12">
              <label class="control-label requiredField blue" for="loan-customers-data-list">
               Type | Select Customer Account No
              </label>
               <input  id="txt-loan-customers-data-list" class="form-control" list="loan-customers-data-list">
               <datalist id="loan-customers-data-list">
          ...
          <div class="clearfix loan_customer_data"></div>
        </form>
      </div>
  </div>
</div>
